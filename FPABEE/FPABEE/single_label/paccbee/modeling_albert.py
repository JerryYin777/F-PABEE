...
class AlbertModel(AlbertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        ###########
        #self.early_exit_entropy = [0.06 for _ in range(config.num_hidden_layers)]
        ###########
    ...
    Example::
        ...
        encoder_outputs1 = encoder_outputs
        ...
        if self.training:
            ...
            for i in range(self.config.num_hidden_layers):
                ...
                #print('i',i)
                #print('i+1',i+1)
                #print('self.config.num_hidden_layers',self.config.num_hidden_layers)
                if i < (self.config.num_hidden_layers-1):
                    ...
                    #print('logits',logits)
                    logits1 = output_layers[i](pooled_output1)
                    #########
                    ...
                    #########
                    if regression:
                        print('regression logits',logits)
